      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mt-4">
            Explore a nossa vasta gama de cores de verniz. Passe o cursor sobre
            uma cor para ver como fica nas unhas.
          </p>
        </motion.div>
            ...
            <div className="flex items-start mb-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Se tem uma cor específica em mente que não vê aqui,
                  contacte-nos. Podemos criar tons personalizados para atender
